...
const Blog = () => {
    useTitle('Blog');
    return (
        <div className="container my-5 mx-auto mb-5">
            <div className="mx-5 bg-yellow-300 p-5 font-bold rounded-xl">
                <h1 className="text-3xl mb-6">1. What is an access token and refresh token? How do they work and where should we store them on the client-side?</h1>
                <div>
            ...
            <div className="mx-5 bg-blue-300 p-5 font-bold mt-5 rounded-xl">
            ...
            <div className="mx-5 bg-green-300 p-5 font-bold mt-5 rounded-xl">
                <div>
            ...
            <div className="mx-5 bg-purple-300 p-5 font-bold mt-5 rounded-xl">
                <div>
                ...
                <div>
                    ...
                    <article>
                        ...
                        The aggregation framework in MongoDB provides a pipeline-based approach where multiple stages can be chained together to perform complex data operations. Each stage in the pipeline receives input data from the previous stage and passes its output to the next stage.
                    </article>
                </div>
            </div>
        </div>
