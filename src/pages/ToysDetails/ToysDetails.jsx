    ...
    return (
        <div>
            <div className="mt-20 mb-20 flex justify-center">
                <div className="card card-side bg-base-100 shadow-xl  h-full  relative overflow-hidden">
                    <figure>
                        <img className='lg:w-96 max-h-full' src={toys?.picture} alt={toys?.name} />
                    </figure>
                    <div className="card-body">
                        <h2 className="card-title font-bold">{toys?.name}</h2>
                        <p>{toys?.description}</p>
                        <p>Price: ${toys?.price}</p>
                        <p ><span className='flex '><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
