            ...
            <footer className=" text-white container mx-auto  bg-gradient-to-r from-slate-900  to-slate-800  py-10">
                <div className="container mx-auto p-6 text-white flex flex-wrap justify-between">
                    ...
                    <div className="w-full md:w-1/3 lg:w-1/4 mb-4 ">
                        ...
                        <p className="">Email: info@toysrus.com</p>
                        <p className="">Phone: +1 123-456-7890</p>
                    </div>
                    <div className="w-full md:w-1/3 lg:w-1/4 mb-4 ">
                        <h5 className="font-semibold  mb-2">Follow Us</h5>
                        <div className="flex">
                            <a href="#" className="mr-2  hover:text-blue-500 transition-colors duration-300"> <FaFacebook></FaFacebook> </a>

                            <a href="#" className="mr-2  hover:text-blue-500 transition-colors duration-300"><FaTwitter></FaTwitter>
                            </a>
                            <a href="#" className="mr-2  hover:text-blue-500 transition-colors duration-300"><FaInstagram></FaInstagram> </a>
                            <a href="#" className="mr-2  hover:text-blue-500 transition-colors duration-300"><FaPinterest></FaPinterest> </a>
                        </div>
                    </div>
                    <div className="w-full md:w-1/3 lg:w-1/4 mb-4 ">
                        <h5 className="font-semibold  mb-2">Address</h5>
                        <p className="">123 Toy Street</p>
