...
const Banner = () => {
    return (
        <div>
            <div className="carousel w-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] " >
                <div id="slide1" className="carousel-item relative w-full ">
                    <img src="https://images.unsplash.com/photo-1551524612-4b158646bc05?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=945&q=80" className="w-full max-h-96  rounded-xl" />
                ...
                <div id="slide3" className="carousel-item relative max-h-96 w-full">
                    <img src="https://images.unsplash.com/photo-1479740030693-66ad10f3a7b0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80" className="w-full max-h-96" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
